({
    ...
    selectSalesforce: function (component, event, helper) {   
         component.set("v.selectedMenu", "salesforce");

    },
    selectFile: function (component, event, helper) {
          component.set("v.selectedMenu", "file");


    },
    selectUrl: function (component, event, helper) {
          component.set("v.selectedMenu", "url");
    }
})