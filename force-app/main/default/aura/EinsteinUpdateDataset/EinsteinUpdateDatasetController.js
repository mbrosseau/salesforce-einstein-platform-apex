({
     ...
     doInit : function(component, event, helper) {
         ...
         console.log("Update from file Init");
	...
	onUpdateDatasetFromURL : function (component, event, helper) {
        helper.updateDatasetWithUrl(component);
    },
    onUpdateDatasetFromZip : function (component, event, helper) {
       // helper.updateDatasetFromUrl(component);
    },
    selectSingle: function (component, event, helper) {   
         component.set("v.selectedButton", "single");
    },
    selectFile: function (component, event, helper) {
          component.set("v.selectedButton", "file");


    },
    selectUrl: function (component, event, helper) {
          component.set("v.selectedButton", "url");
    }
})