({
  onModelsTab: function(component, event, helper) {
    helper.refreshModelsByDataset(component);
 ...
 onRefreshDataset: function(component, event, helper) {
    helper.refreshDataset(component);
  },
  ...
  onReTrainModel: function (component, event, helper) {
    ...
    var dataset = component.get("v.dataset");
      ...
      if( modelId == null || modelId.length == 0) {
           modelId = component.get("v.modelList")[0].modelId;
      }
